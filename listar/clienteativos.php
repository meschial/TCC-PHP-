				...
				<?php
					...
					while ( $linha = $consulta->fetch(PDO::FETCH_OBJ)) {
						...
						echo "<tr>
							...
							<td>$novotipo</td>
							<td>
								<a type='button' href='cadastrar/desativarcliente/$id' class='btn btn-success'>Ver dados</a>								
							</td>
						</tr>";
					}
				?>
				...
				<?php
					...
					while ( $linha = $consulta->fetch(PDO::FETCH_OBJ)) {
						...
						echo "<tr>
							...
							<td>$novotipo</td>
							<td>
								<a type='button' href='cadastrar/desativarmotorista/$id' class='btn btn-success'>Ver dados</a>								
							</td>
						</tr>";
					}
				?>
